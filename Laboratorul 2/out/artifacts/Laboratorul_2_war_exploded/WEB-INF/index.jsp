...
<form method="post" action="RecordController">
    ...
    <input type="text" placeholder="Enter text from the image below" name="captchaInput" required>
    <img src="CaptchaController">
    <input type="checkbox" name="getAll" value="getAll">Get all records*
    <p>* = if not checked the server will only return your records</p>
